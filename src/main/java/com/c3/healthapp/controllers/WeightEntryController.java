...
public class WeightEntryController {
    ...
    public ResponseEntity<WeightEntry> saveUserWeightEntry(@RequestBody WeightEntry weightEntry) {
        ...
        return ResponseEntity.created(uri).body(userService.saveWeightEntry(username, weightEntry));
    }
}
